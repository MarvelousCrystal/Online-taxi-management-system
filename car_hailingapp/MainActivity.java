...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private  EditText number; //用户名输入框
...
//    private EditText new_again_password;//注册页面的再次输入密码框
    ...
    private void initialize(){
        number=(EditText)findViewById(R.id.number_text); //创建用户名输入框对象
...
//                    .setPositiveButton("好的",null).show();
            Toast.makeText(MainActivity.this,"用户名格式不对，请输入5位数字",Toast.LENGTH_LONG).show();
...
//
        ...
        boolean flag=loginImpl.isloging(this,numbertext,passwordtext);
        if(!flag){
            //如果登录不成功
            Toast.makeText(MainActivity.this,"用户账号或密码错误",Toast.LENGTH_LONG).show();
            ...
            Intent intent = new Intent(MainActivity.this, Manager_function.class);
            startActivity(intent);
