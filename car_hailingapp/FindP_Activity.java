...
public class FindP_Activity extends AppCompatActivity implements View.OnClickListener {
    private EditText findPassenger;
    ...
    static class MyHandler extends Handler {
        WeakReference<FindP_Activity> fActivity;
        MyHandler(WeakReference<FindP_Activity> activity){
    ...
    private void init() {
        findPassenger=(EditText)findViewById(R.id.find_pnumber_text);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.find_no_button:
                Intent intent=new Intent(FindP_Activity.this,Manager_function.class);
    ...
    private void getresult() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String find_Pnumber=findPassenger.getText().toString().trim();
                try {
                    Order_InterfaceImple impl=new Order_InterfaceImple();
                    con=impl.connect();
                    con.setAutoCommit(false);
                    String result=impl.findPassenger(con,find_Pnumber);
                    if(result!=null){
