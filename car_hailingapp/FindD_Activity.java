...
public class FindD_Activity extends AppCompatActivity implements View.OnClickListener {
    private EditText findDriver;
    ...
    static class MyHandler extends Handler {
        WeakReference<FindD_Activity> fActivity;
        MyHandler(WeakReference<FindD_Activity> activity){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_findd);
        setTitle("查询订单");
        init();
    ...
    private void init() {
        findDriver=(EditText)findViewById(R.id.find_dnumber_text);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.find_no_button:
                Intent intent=new Intent(FindD_Activity.this,Manager_function.class);
    ...
    private void getresult() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String find_Dnumber=findDriver.getText().toString().trim();
                try {
                    Order_InterfaceImple impl=new Order_InterfaceImple();
                    con=impl.connect();
                    con.setAutoCommit(false);
                    String result=impl.findDriver(con,find_Dnumber);
                    if(result!=null){
